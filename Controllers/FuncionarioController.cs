...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        // FEITO: Chamar o método SaveChanges do _context para salvar no Banco SQL
        ...
        // FEITO: Chamar o método UpsertEntity para salvar no Azure Table
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // FEITO: As propriedades estão incompletas
        ...
        // FEITO: Chamar o método de Update do _context.Funcionarios para marcar a entidade como modificada
    ...
    public IActionResult Deletar(int id)
    {
        ...
        // FEITO: Chamar o método de Remove do _context.Funcionarios para salvar no Banco SQL
